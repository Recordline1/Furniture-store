...
function initSliders() {
  let thumbSwiper;
  if (document.querySelector(".single__slider-smal")) {
    thumbSwiper = new Swiper(".single__slider-smal", {
      modules: [Navigation],
      direction: "vertical",
      observer: true,
      observeParents: true,
  ...
  if (document.querySelector(".single__slider-main")) {
    new Swiper(".single__slider-main", {
...
const sizeButtons = document.querySelectorAll(".info__sizes > .sizes__item");
...
const colors = document.querySelectorAll(".info__colors > .colors__item ");
